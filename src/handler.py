...
aws_account_ids = [os.getenv('AWS_ACCOUNT')]
default_days_of_retention = int(os.getenv('DEFAULT_RETENTION'))
    ...
    for volume in volumes:
        ...
        ec.create_tags(
          ...
          Tags=[
            ...
            {'Key': 'DeleteAfterDate', 'Value': datetime.datetime.fromtimestamp(int(delete_ts)).strftime('%Y-%m-%d %H:%M:%S')}
          ]
        )
